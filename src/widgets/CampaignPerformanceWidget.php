...
/**
 * Campaign Manager campaign performance dashboard widget.
 *
 * @since 5.13.0
 */
class CampaignPerformanceWidget extends Widget
{
    ...
    /**
     * @var int Number of campaigns to show
     */
    public int $limit = 5;
    ...
    public static function displayName(): string
    {
        ...
        return $pluginName . ' - ' . Craft::t('campaign-manager', 'Performance');
    }
    ...
    {
        return Craft::$app->getView()->renderTemplate('campaign-manager/widgets/campaign-performance/settings', [
            'widget' => $this,
