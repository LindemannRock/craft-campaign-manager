...
return [
    ...
    'This is being overridden by the <code>defaultProviderHandle</code> setting in <code>config/campaign-manager.php</code>.' => 'يتم تجاوز هذا الإعداد بواسطة إعداد <code>defaultProviderHandle</code> في <code>config/campaign-manager.php</code>.',
    ...
    'Copy reference template from <code>plugins/campaign-manager/src/templates/invite.twig</code> to <code>templates/campaign-manager/invite.twig</code>' => 'نسخ Template المرجع من <code>plugins/campaign-manager/src/templates/invite.twig</code> إلى <code>templates/campaign-manager/invite.twig</code>',
    ...
    'Use {invitationUrl} to include the invitation link.' => 'استخدم {invitationUrl} لتضمين رابط الدعوة.',
    ...
    'Use {invitationUrl} to include the invitation link. HTML is supported.' => 'استخدم {invitationUrl} لتضمين رابط الدعوة. يتم دعم HTML.',
