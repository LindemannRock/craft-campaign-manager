...
return [
    ...
    'This is being overridden by the <code>defaultProviderHandle</code> setting in <code>config/campaign-manager.php</code>.' => 'Dette overstyres av innstillingen <code>defaultProviderHandle</code> i <code>config/campaign-manager.php</code>.',
    ...
    'Copy reference template from <code>plugins/campaign-manager/src/templates/invite.twig</code> to <code>templates/campaign-manager/invite.twig</code>' => 'Kopier referansemalen fra <code>plugins/campaign-manager/src/templates/invite.twig</code> til <code>templates/campaign-manager/invite.twig</code>',
    ...
    'Use {invitationUrl} to include the invitation link.' => 'Bruk {invitationUrl} for å inkludere invitasjonslenken.',
    ...
    'Use {invitationUrl} to include the invitation link. HTML is supported.' => 'Bruk {invitationUrl} for å inkludere invitasjonslenken. HTML støttes.',
    ...
    'Auto (detect)' => 'Automatisk (gjenkjenn)',
    'Comma (,)' => 'Komma (,)',
    'Semicolon (;)' => 'Semikolon (;)',
    'Tab' => 'Tab',
    'Pipe (|)' => 'Vertikalstrek (|)',
