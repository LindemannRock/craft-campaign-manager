...
return [
    ...
    'Delete {count} recipient? This cannot be undone.' => '¿Eliminar {count} destinatario? Esta acción no se puede deshacer.',
    'Delete {count} recipients? This cannot be undone.' => '¿Eliminar {count} destinatarios? Esta acción no se puede deshacer.',
    ...
    'No SMS provider configured for this campaign. Configure a provider in the campaign settings to enable SMS invitations.' => 'No hay ningún proveedor SMS configurado para esta campaña. Configure un proveedor en la configuración de la campaña para activar las invitaciones SMS.',
