...
return [
    ...
    'This is being overridden by the <code>defaultProviderHandle</code> setting in <code>config/campaign-manager.php</code>.' => '<code>config/campaign-manager.php</code> の <code>defaultProviderHandle</code> 設定で上書きされています。',
    ...
    'Use {invitationUrl} to include the invitation link.' => '{invitationUrl} を使用して招待リンクを含めてください。',
    'Email Settings' => 'Email 設定',
    'Email Invitation Subject' => 'Email 招待件名',
    'Email Invitation Message' => 'Email 招待メッセージ',
    'Use {invitationUrl} to include the invitation link. HTML is supported.' => '{invitationUrl} を使用して招待リンクを含めてください。HTML に対応しています。',
