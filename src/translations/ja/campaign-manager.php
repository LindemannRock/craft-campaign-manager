...
return [
    ...
    'Delete {count} recipient? This cannot be undone.' => '{count} 件の受信者を削除しますか？この操作は元に戻せません。',
    'Delete {count} recipients? This cannot be undone.' => '{count} 件の受信者を削除しますか？この操作は元に戻せません。',
