...
class ImportRecipientsAction extends ElementAction
{
    ...
    {
        return Craft::t('campaign-manager', 'Import Recipients');
    }
...
(() => {
    new Craft.ElementActionTrigger({
        ...
        activate: (\$selectedItems) => {
            ...
            window.location.href = Craft.getCpUrl('campaign-manager/campaigns/' + campaignId + '/import-recipients', { site: siteHandle });
        },
    });
})();
JS, [static::class]);
